...
public interface ProductService {
  Slice<ProductDTO> findAll(ProductRequestQueryDTO productRequestQueryDTO, int page);

  Slice<ProductDTO> findAll(int page);

  ProductDTO findById(String id);

  Slice<ProductDTO> findAllOrderByClosest(double latitude, double longitude, int page);
